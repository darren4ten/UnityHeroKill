...
public class MultiVideoDemo : MonoBehaviour 
{
	...
	private List<AVProQuickTimeGUIDisplay> _movies;
	private AVProQuickTimeGUIDisplay _activeMovie;
	private AVProQuickTimeGUIDisplay _removeMovie;
	...
	void Update()
	{
		...
		_activeMovie = null;
		foreach (AVProQuickTimeGUIDisplay gui in _movies)
		{
	...
	void Start()
	{
		...
		_movies = new List<AVProQuickTimeGUIDisplay>();

		// Add some initial videos
		Add("Assets/AVProQuickTime/Demos/Shared/", "grey-480x256.mp4.bin");
		Add("Assets/AVProQuickTime/Demos/Shared/", "green-480x256.mp4.bin");
		Add("Assets/AVProQuickTime/Demos/Shared/", "purple-480x256.mp4.bin");
		Add("Assets/AVProQuickTime/Demos/Shared/", "grey-480x256.mp4.bin");
	}
	...
	private void Remove(AVProQuickTimeGUIDisplay movie)
	{
		if (movie)
		{
	...
	private void UpdateLayout()
	{
		...
		{
			AVProQuickTimeGUIDisplay gui = _movies[i];
